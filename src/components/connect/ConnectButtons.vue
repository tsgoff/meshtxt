<template>
    <div class="space-y-2">
        ...
        <!-- http -->
        <RouterLink :to="{ name: 'connect.http' }" class="flex">
            <button type="button" class="w-full flex cursor-pointer bg-white rounded shadow px-3 py-2 text-black space-x-2 font-semibold hover:bg-gray-100">
                <span>
